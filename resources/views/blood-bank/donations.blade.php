    ...
    <section class="section dashboard">
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Donations
                        <a href="/load-donation-form" class="btn btn-success btn-sm mx-3 float-end">add new</a>
                    </h5>
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            @if (count($all_donors) > 0)
                                ...
                                @endif
                                <td><a href="/admin/edit-donor/{{ $item->id }}" class="btn btn-primary btn-sm">Add
                                        Donation</a></td>
                                </tr>
                            @endforeach
                        @else
